...
public class Circle : NSObject {
    ...
    public class func drawCircleFilled(label label: String = "Rash") {
        ...
        let textFontAttributes = [NSFontAttributeName: UIFont.systemFontOfSize(25), NSForegroundColorAttributeName: UIColor.whiteColor(), NSParagraphStyleAttributeName: textStyle]
    ...
    public class func drawCircleEmpty(label label: String = "Rash") {
        ...
        let textFontAttributes = [NSFontAttributeName: UIFont.systemFontOfSize(25), NSForegroundColorAttributeName: Circle.color, NSParagraphStyleAttributeName: textStyle]
